document.addEventListener('DOMContentLoaded', () => {
    ...
    // Enemy types
    const enemies = [
        { name: 'Goblin', image: 'goblin.png', health: 100 },
        { name: 'Orc', image: 'orc.png', health: 150 },
        { name: 'Troll', image: 'troll.png', health: 200 },
        { name: 'Dragon', image: 'dragon.png', health: 300 },
        { name: 'Demon', image: 'demon.png', health: 400 }
    ];
